...
describe('Validar rotas de Escolas SimplÃ­ssima Com EOL da aplicaÃ§Ã£o SIGPAE', () => {
	...
	context('Rota api/escolas-simplissima-com-dre-unpaginated/', () => {
		it('Validar GET de Escolas Simplissima com DRE Unpaginated com UUID vÃ¡lido', () => {
		...
		it('Validar GET de Escolas Simplissima com DRE Unpaginated com UUID invÃ¡lido', () => {
