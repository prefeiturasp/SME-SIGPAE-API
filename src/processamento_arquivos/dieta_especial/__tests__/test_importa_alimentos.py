...
from src.processamento_arquivos.dieta_especial import importa_alimentos as imp_alimentos
from src.processamento_arquivos.dieta_especial.importa_alimentos import (
    ProcessadorPlanilha,
)
