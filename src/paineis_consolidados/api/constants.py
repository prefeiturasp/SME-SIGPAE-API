...
COL_IDX_ENCERRADO_A_PARTIR_DE = 6
COL_IDX_DIA_DA_SEMANA = 7
COL_IDX_PERIODO = 8
COL_IDX_TIPO_DE_ALIMENTACAO = 9
COL_IDX_TIPO_DE_ALTERACAO = 10
COL_IDX_NUMERO_DE_ALUNOS = 11
COL_IDX_NUMERO_TOTAL_KITS = 12
COL_IDX_OBSERVACOES = 13
COL_IDX_DATA_LOG = 14
