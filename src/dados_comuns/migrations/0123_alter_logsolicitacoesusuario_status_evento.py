# Generated by Django 5.2.2 on 2025-10-06 12:43
...
def substituir_status_evento(apps, _):
    ...
    SolicitacaoDietaEspecial = apps.get_model(
        "dieta_especial", "SolicitacaoDietaEspecial"
    )

    solicitacoes_alteracao_ue_uuids = SolicitacaoDietaEspecial.objects.filter(
        tipo_solicitacao="ALTERACAO_UE"
    ).values_list("uuid", flat=True)

    LogSolicitacoesUsuario.objects.filter(
        status_evento=4,  # CODAE_NEGOU
        solicitacao_tipo=8,  # DIETA_ESPECIAL
        uuid_original__in=solicitacoes_alteracao_ue_uuids,
    ).update(
        status_evento=106,  # CODAE_NEGOU_ALTERACAO_UE_DIETA_ESPECIAL
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("dados_comuns", "0122_alter_logsolicitacoesusuario_status_evento"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (68, "Assinado Abastecimento"),
                    (69, "Assinado CODAE"),
                    (70, "Vínculo do Edital ao Produto"),
                    (71, "Cronograma Ciente"),
                    (72, "Fornecedor Ciente"),
                    (73, "Aprovado Abastecimento"),
                    (74, "Reprovado Abastecimento"),
                    (75, "Aprovado DILOG"),
                    (76, "Reprovado DILOG"),
                    ...
                    (101, "Medição sem lançamentos"),
                    (102, "Ficha de Recebimento assinada"),
                    (103, "CODAE autorizou o cancelamento"),
                    (104, "Solicitação de Alteração de UE Realizada"),
                    (105, "CODAE autorizou a Alteração de UE"),
                    (106, "CODAE negou a Alteração de UE"),
                ]
            ),
        ),
