...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("dados_comuns", "0130_alter_logsolicitacoesusuario_status_evento"),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (110, "Cronograma Criado"),
                    (111, "Cronograma Semanal Enviado ao Fornecedor"),
                    (112, "Fornecedor Ciente"),
                    ...
                    (107, "Ocorrência excluída pela Escola"),
                    (108, "CODAE inativou"),
                    (109, "Cancelamento por Encerramento de Matrícula"),
                    (113, "Escola alterou"),
                ]
            ),
        ),
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    (
                        "CRONOGRAMA_PONTO_A_PONTO",
                        "Assinatura do Cronograma Ponto a Ponto",
                    ),
                ],
                max_length=50,
        ...
        migrations.AlterField(
            ...
            name="link",
            field=models.CharField(
                blank=True, default="", max_length=200, verbose_name="Link"
            ),
        ),
    ]
