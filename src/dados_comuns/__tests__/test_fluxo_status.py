...
@patch(
    "src.dados_comuns.fluxo_status.FluxoDietaEspecialPartindoDaEscola._preenche_template_e_envia_email"
)
...
@patch("src.dados_comuns.fluxo_status.convert_base64_to_contentfile")
def test_deve_acumular_logs_ao_corrigir_multiplas_vezes(
    ...
    mock_convert_base64.return_value = ContentFile(b"arquivo fake", name="doc1.pdf")

    kwargs_1 = {
        "user": usuario,
        "justificativa": "Primeira correção",
        "anexos": [{"nome": "doc1.pdf", "base64": "qualquer-coisa"}],
    }

    kwargs_2 = {
        "user": usuario,
        "justificativa": "Segunda correção",
        "anexos": [{"nome": "doc2.pdf", "base64": "qualquer-coisa"}],
    }
...
def test_deve_manter_anexos_de_todos_os_logs(
    ...
    mock_convert_base64.return_value = ContentFile(b"arquivo fake", name="anexo.pdf")

    kwargs_1 = {
        "user": usuario,
        "justificativa": "Correção 1",
        "anexos": [{"nome": "anexo1.pdf", "base64": "qualquer-coisa"}],
    }

    kwargs_2 = {
        "user": usuario,
        "justificativa": "Correção 2",
        "anexos": [{"nome": "anexo2.pdf", "base64": "qualquer-coisa"}],
    }
