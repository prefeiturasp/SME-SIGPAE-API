...
from src.dados_comuns.parser_xml import ListXMLParser
...
from src.eol_servico.utils import EOLPapaService
from src.logistica.api.serializers.serializer_create import (
...
from src.logistica.api.serializers.serializers import (  # noqa
...
from src.logistica.models import Guia as GuiasDasRequisicoes
from src.logistica.models import (
    NotificacaoOcorrenciasGuia,
    SolicitacaoDeAlteracaoRequisicao,
    SolicitacaoRemessa,
)
from src.logistica.services import (
    arquiva_guias,
