...
from src.logistica.api.soup.token_auth import TokenAuthentication
from src.logistica.models import Guia as model_guia
from src.logistica.models.solicitacao import (
