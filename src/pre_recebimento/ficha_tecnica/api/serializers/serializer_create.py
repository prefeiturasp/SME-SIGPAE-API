...
from src.produto.models import Fabricante, Marca, NomeDeProdutoEdital
...
class AnaliseFichaTecnicaCreateSerializer(serializers.ModelSerializer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if (
            ficha_tecnica
            and ficha_tecnica.categoria == "FLV"
            and ficha_tecnica.tipo_entrega == "PONTO_A_PONTO"
        ):
