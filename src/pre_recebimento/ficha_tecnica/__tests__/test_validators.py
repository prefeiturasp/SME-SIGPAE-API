...
from src.pre_recebimento.ficha_tecnica.api.validators import (
...
def test_valida_campos_flv_erro_campo_obrigatorio_faltando():
    ...
    AnaliseFichaTecnicaFactory(ficha_tecnica=ficha, detalhes_produto_conferido=False)

    # Faltando 'especie_variedade' que é obrigatório para FLV em detalhes_produto
    attrs = {"organico": True, "mecanismo_controle": "Audit"}
