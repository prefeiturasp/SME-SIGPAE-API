...
from src.pre_recebimento.ficha_tecnica.api.serializers.serializer_create import (
...
def test_analise_normal_valida(
    payload_analise_aprovada, ficha_tecnica_nao_perecivel, usuario
):
...
def test_analise_normal_conferido_false_com_correcoes_valido(
    payload_analise_aprovada, ficha_tecnica_nao_perecivel, usuario
):
...
def test_analise_normal_conferido_false_sem_correcoes_invalido(
    payload_analise_aprovada, ficha_tecnica_nao_perecivel, usuario
):
    payload_analise_aprovada.update(
        {
...
def test_analise_normal_conferido_true_com_correcoes_invalido(
    payload_analise_aprovada, ficha_tecnica_nao_perecivel, usuario
):
    payload_analise_aprovada.update(
        {
...
def test_analise_normal_campos_inexistentes_para_flv_sao_obrigatorios(
    ficha_tecnica_nao_perecivel, usuario
):
...
def test_analise_flv_valida_sem_campos_inexistentes(
...
def test_analise_flv_campos_inexistentes_ignorados_mesmo_se_enviados(
    payload_analise_flv_aprovada, ficha_tecnica_flv, usuario
):
