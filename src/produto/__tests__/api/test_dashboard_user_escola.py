...
from src.produto.fixtures.factories.produto_factory import (
...
from src.produto.models import HomologacaoProduto
...
class TestDashboardGestaoProdutos:
    ...
    def test_questionamento_da_codae(
        ...
        self.gera_reclamacao(escola, usuario)
        self.reclamacao.status = ReclamacaoProdutoWorkflow.AGUARDANDO_RESPOSTA_UE
