...
from src.perfil.management.commands import verifica_parceiras as vp
...
@patch("src.perfil.management.commands.verifica_parceiras.consultar_api")
@patch("src.perfil.management.commands.verifica_parceiras.extrair_cpfs_pdf")
@patch("src.perfil.management.commands.verifica_parceiras.salvar_excel")
