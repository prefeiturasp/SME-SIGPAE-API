...
def test_cria_ou_atualiza_usuario_core_sso_criar_usuario():
    ...
    with patch(
        ...
        "src.eol_servico.utils.EOLServicoSGP.usuario_core_sso_or_none",
        return_value=None,
    ), patch(
        "src.eol_servico.utils.EOLServicoSGP.atribuir_perfil_coresso"
...
def test_cria_ou_atualiza_usuario_core_sso_atualizar_email():
    ...
    with patch(
        ...
        "src.eol_servico.utils.EOLServicoSGP.redefine_email"
