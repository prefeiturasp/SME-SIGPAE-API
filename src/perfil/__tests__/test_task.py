...
@patch("src.perfil.tasks.compara_e_atualiza_dados_do_eol")
@patch("src.eol_servico.utils.EOLServicoSGP.get_dados_usuario")
@patch("src.perfil.tasks.get_usuario")
