...
from src.medicao_inicial.recreio_nas_ferias.validators.recreio_cemei import validate_lancamento_alimentacoes_medicao_recreio_cemei
...
def test_validate_lancamento_alimentacoes_medicao_recreio_cemei(solicitacao_recreio_cemei):
