...
class TestGeraRelatorioMedicaoComHistoricoEscola:
    ...
    @patch("src.medicao_inicial.tasks.relatorio_solicitacao_medicao_por_escola")
    @patch("src.medicao_inicial.tasks.relatorio_solicitacao_medicao_por_escola_cemei")
