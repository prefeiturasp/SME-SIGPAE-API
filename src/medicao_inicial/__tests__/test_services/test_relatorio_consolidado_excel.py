...
def test_gera_relatorio_consolidado_xlsx_cei(
    ...
    assert rows[3] == (
        ...
        FaixasEtarias.SEIS_A_SETE_MESES.value,
        FaixasEtarias.OITO_A_ONZE_MESES.value,
        FaixasEtarias.UM_ANO_A_UM_ANO_E_ONZE_MESES.value,
        FaixasEtarias.DOIS_ANOS_A_TRES_ANOS_E_ONZE_MESES.value,
