...
from src.medicao_inicial.models import Responsavel, SolicitacaoMedicaoInicial
from src.medicao_inicial.services.relatorio_adesao import obtem_resultados
...
class GeraPDFRelatorioSolicitacaoMedicaoPorEscolaAsyncTest(TestCase):
    @patch("src.medicao_inicial.tasks.gera_objeto_na_central_download")
    @patch("src.medicao_inicial.tasks.atualiza_central_download")
    @patch("src.relatorios.relatorios.relatorio_solicitacao_medicao_por_escola")
    @patch("src.medicao_inicial.tasks.SolicitacaoMedicaoInicial.objects.get")
    @patch("src.medicao_inicial.tasks.logger.info")
...
class GeraPDFRelatorioUnificadoMedicoesIniciaisAsyncTest(TestCase):
    @patch("src.medicao_inicial.tasks.gera_objeto_na_central_download")
    @patch("src.medicao_inicial.tasks.atualiza_central_download")
    @patch("src.relatorios.relatorios.relatorio_consolidado_medicoes_iniciais_emef")
    @patch("src.relatorios.relatorios.relatorio_solicitacao_medicao_por_escola")
    @patch("src.medicao_inicial.tasks.SolicitacaoMedicaoInicial.objects.get")
    @patch("src.medicao_inicial.tasks.logger.info")
