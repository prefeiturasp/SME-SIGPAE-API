...
from src.recebimento.fixtures.factories.questao_ficha_recebimento_factory import (
    QuestaoFichaRecebimentoFactory,
)
from src.recebimento.fixtures.factories.questoes_por_produto_factory import (
...
def veiculo_ficha_recebimento(ficha_recebimento):
    ...
    from src.recebimento.models import VeiculoFichaDeRecebimento
...
def arquivo_ficha_recebimento(ficha_recebimento):
    ...
    from src.recebimento.models import ArquivoFichaRecebimento
