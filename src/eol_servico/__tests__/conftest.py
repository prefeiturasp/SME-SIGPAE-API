...
import src.escola.models as models
...
def diretoria_regional():
    return baker.make(models.DiretoriaRegional, nome="DRE Teste", codigo_eol="123456")
...
def mock_serializer_usuario_codae():
    ...
    return {
        ...
        "vinculo_atual": {
            "perfil": {"visao": "CODAE"},
            "instituicao": {"codigo_eol": "123456", "nome": "QUALQUER ESCOLA"},
        },
    }
