...
from src.dieta_especial.solicitacao_dieta_especial.api.filters import (
    AlimentoFilter,
    DietaEspecialFilter,
    MotivoNegacaoFilter,
)
...
from src.dieta_especial.solicitacao_dieta_especial.api.serializers_create import (
...
from src.paineis_consolidados.api.constants import FILTRO_CODIGO_EOL_ALUNO
...
class SolicitacaoDietaEspecialViewSet(
    ...
    def solicitacoes_vigentes(self, request, codigo_eol_aluno=None):
        ...
        for solicitacao in page:
            if str(solicitacao.uuid) in uuids_inativas:
