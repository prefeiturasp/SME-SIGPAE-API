...
def contrato():
    return baker.make(
        Contrato, numero="1", processo="12345", programa=Contrato.ALIMENTACAO_ESCOLAR
    )
...
def mock_connection(mock_cursor):
    with patch("src.terceirizada.utils.connection.cursor") as mock_conn:
