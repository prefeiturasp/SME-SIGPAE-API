...
from src.cardapio.alteracao_tipo_alimentacao.api import (
    viewsets as alteracao_tipo_alimentacao_viewsets,
)
from src.cardapio.alteracao_tipo_alimentacao_cei.api import (
    viewsets as alteracao_tipo_alimentacao_cei_viewsets,
)
from src.cardapio.alteracao_tipo_alimentacao_cemei.api import (
    viewsets as alteracao_tipo_alimentacao_cemei_viewsets,
)
from src.cardapio.base.api import viewsets as base_viewsets
from src.cardapio.base.api.viewsets import (
    VinculosPorTipoUnidadeEscolarViewSet,
)
from src.cardapio.inversao_dia_cardapio.api import (
    viewsets as inversao_dia_cardapio_viewsets,
)
from src.cardapio.suspensao_alimentacao.api import (
    viewsets as suspensao_alimentacao_viewsets,
)
from src.cardapio.suspensao_alimentacao_cei.api import (
