...
from src.dieta_especial.logs_models.fixtures.factories.base import (
    LogQuantidadeDietasAutorizadasCEIFactory,
    LogQuantidadeDietasAutorizadasFactory,
)
from src.pre_recebimento.ficha_tecnica.fixtures.factories.fabricante_ficha_tecnica_factory import (
    FabricanteFichaTecnicaFactory,
)
from src.recebimento.fixtures.factories.ocorrencia_ficha_recebimento_factory import (
...
def eolservicosgp_get_lista_alunos(monkeypatch):
    with open("src/escola/__tests__/massa_eolservicosgp_lista_alunos.json") as jsfile:
        js = json.load(jsfile)
