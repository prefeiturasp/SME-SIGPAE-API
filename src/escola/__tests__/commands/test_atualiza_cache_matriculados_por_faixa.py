...
class AtualizaCacheMatriculadosPorFaixaCommandTest(TestCase):
    ...
    def setUp(self) -> None:
        ...
        with open(
            "src/escola/__tests__/commands/mocks/mock_ue_400020_dados_alunos_2025.json",
            "r",
        ) as file:
        ...
        with open(
            "src/escola/__tests__/commands/mocks/mock_ue_400509_dados_alunos_2025.json",
            "r",
        ) as file:
    ...
    @patch(
        "src.escola.management.commands.atualiza_cache_matriculados_por_faixa.redis_connection"
    )
    @patch("src.eol_servico.utils.EOLServicoSGP.get_alunos_por_escola_por_ano_letivo")
