...
def test_gera_dict_codigo_aluno_por_codigo_escola(variaveis_globais):
    ...
    assert variaveis_globais[1] == {"0020001": "123456789", "0020002": "987654321"}
...
# TODO: Fazer
def test_retorna_alunos_nao_matriculados_na_escola():
...
# TODO: Fazer
def test_retorna_dados_sigpae():
    pass


# def test_retorna_dados_sigpae_exception():
#     arquivo_saida = f"/tmp/{uuid.uuid4()}.xlsx"
#     wb = openpyxl.Workbook()
#     wb.save(arquivo_saida)
...
#     with pytest.raises(Exception):
#         retorna_dados_sigpae(items_codigos_escolas, arquivo_saida)
...
def escreve_xlsx_alunos_com_nascimento_diferente():
    alunos = {
...
# TODO: Fazer
def test_retorna_alunos_com_nome_diferente():
    pass


def test_retorna_alunos_com_nascimento_diferente():
    pass
