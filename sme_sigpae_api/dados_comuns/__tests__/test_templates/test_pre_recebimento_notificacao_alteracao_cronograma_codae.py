...
def test_template_email_base():
    ...
    template = "pre_recebimento_notificacao_alteracao_cronograma_codae.html"
    hidden_email = None
    ...
    assert (
        f"A <strong>CODAE</strong> realizou Alterações no Cronograma <strong>Nº {numero_cronograma}</strong>"
        in html
    )
