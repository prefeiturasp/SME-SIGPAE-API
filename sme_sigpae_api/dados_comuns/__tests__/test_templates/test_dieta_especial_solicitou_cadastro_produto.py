...
def test_template_email_base():
    ...
    template = "dieta_especial_solicitou_cadastro_produto.html"
    hidden_email = None
    dados_template = {"titulo": titulo, "hidden_email": hidden_email}
    ...
    assert "Solicitação de cadastro de produto realizada com sucesso!" in html
