# Generated by Django 5.2.2 on 2025-10-03 15:44
...
def substituir_status_evento(apps, _):
    ...
    LogSolicitacoesUsuario.objects.filter(
        status_evento=1,  # CODAE_AUTORIZOU
        solicitacao_tipo=8,  # DIETA_ESPECIAL
        uuid_original__in=solicitacoes_alteracao_ue_uuids,
    ).update(
        status_evento=105,  # CODAE_AUTORIZOU_ALTERACAO_UE_DIETA_ESPECIAL
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("dados_comuns", "0121_alter_logsolicitacoesusuario_status_evento"),
    ]
