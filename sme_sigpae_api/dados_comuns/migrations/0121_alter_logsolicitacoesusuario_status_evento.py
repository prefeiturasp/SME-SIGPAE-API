# Generated by Django 5.2.2 on 2025-10-02 16:07
...
def substituir_status_evento(apps, _):
    ...
    LogSolicitacoesUsuario.objects.filter(
        ...
        status_evento=104,  # INICIO_FLUXO_ALTERACAO_UE_DIETA_ESPECIAL
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("dados_comuns", "0120_alter_logsolicitacoesusuario_status_evento"),
    ]
