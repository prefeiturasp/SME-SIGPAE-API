...
from sme_sigpae_api.medicao_inicial.fixtures.factories.solicitacao_medicao_inicial_base_factory import (
    SolicitacaoMedicaoInicialFactory, OcorrenciaMedicaoInicialFactory
)
...
@pytest.mark.usefixtures("client_autenticado_diretoria_regional", "client_autenticado_codae_medicao")
