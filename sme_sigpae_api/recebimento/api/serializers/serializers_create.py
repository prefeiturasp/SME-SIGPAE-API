...
class FichaDeRecebimentoCreateSerializer(serializers.ModelSerializer):
    ...
    data_validade_divergencia = serializers.CharField(
        required=False,
        allow_blank=True
    )
    ...
    veiculos = serializers.ListField(
    ...
    def _validar_campos_divergencia(self, data):
        ...
        campos_divergencia = [
            ('lote_fabricante_de_acordo', 'lote_fabricante_divergencia',
             'Campo obrigatório quando o lote do fabricante não está de acordo.'),

            ('data_fabricacao_de_acordo', 'data_fabricacao_divergencia',
             'Campo obrigatório quando a data de fabricação não está de acordo.'),

            ('data_validade_de_acordo', 'data_validade_divergencia',
